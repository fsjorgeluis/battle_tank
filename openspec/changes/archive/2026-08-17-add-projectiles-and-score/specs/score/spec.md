...
Al empezar una partida nueva (desde el menú o al reintentar desde game over), el
marcador SHALL reiniciarse a 0 y no arrastrar puntuación de partidas anteriores.
