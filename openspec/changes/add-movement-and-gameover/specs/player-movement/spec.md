...
El tanque del jugador SHALL estar definido por una posición (x, y) y un ángulo de cuerpo. Izquierda (btn(0)) SHALL rotar el cuerpo en sentido antihorario y derecha (btn(1)) en sentido horario. Arriba (btn(2)) SHALL acelerar el tanque en la dirección en que apunta el cuerpo y abajo (btn(3)) SHALL hacerlo retroceder. Sin entradas, el tanque SHALL permanecer inmóvil.
