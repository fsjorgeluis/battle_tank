...
Al iniciar una partida SHALL aparecer un enemigo en una posición definida de la arena, con un sprite propio de 12x10 píxeles que lo distinga visualmente del jugador. El sprite del enemigo SHALL ser visible (no vacío) y usar un color diferente al del jugador. El enemigo SHALL permanecer inmóvil durante toda la partida: no se mueve, no cambia de orientación ni de animación.

#### Scenario: Presente al inicio
- **WHEN** una partida comienza
- **THEN** se dibuja un enemigo estático en su posición definida con su sprite característico de 12x10 píxeles visible
